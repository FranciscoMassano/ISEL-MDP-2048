...
def get_amigos(linha):
    ...
    if (n_amigos < 2) or (n_amigos > 5):
        ...
        print("O numero de amigos e INVALIDO. Tem que estar entre 2 e 5.")
...
def regista_grelha_inicial(g11, g12, g13, g14,
    ...
    #inicializacao dasrestantes variaveis
    jogadas = ""
    pontos = None
...
def regista_ranking():
    mensagem = None
    try :
        url_string = "http://ec2-54-171-200-231.eu-west-1.compute.amazonaws.com/cgi-bin/submit_2048.py?numero=" + numero + "&amigos=" + amigos + "&jogadas=" + jogadas + "&pontos=" + str(pontos) + "&semente=" + str(semente)
        ...
        mensagem_cloud = mensagem + str(err)
